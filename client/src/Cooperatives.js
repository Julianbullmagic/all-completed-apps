...
Co-operatives, or "co-ops", are democratic businesses owned and run by the people who work for the company. There are many very successful ones, notably
...
Co-ops have substantially lower variations in income inequality. In the U.S. the average ratio of CEO compensation in the Fortune 500 companies to the ordinary
worker’s has recently been reported as 344:1,49 in co-ops the pay-differential between management and the average worker rarely exceeds 4:1. In
collectives, everyone is usually paid the same amount (ref #1). Co-operative Workers are generally being better paid than Capitalist ones (ref #2) with
...
Kingdom.(Michelle Chen (26 March 2016). "Worker Cooperatives Are More Productive Than Normal Companies". The Nation. Archived from the original on 26 January
2021. Retrieved 27 January 2021) They tend to have a longer lifespan than other types of business. This resilience has been attributed to how cooperatives share risks and rewards between members, how they harness
...
that function well in case of a crisis," and are less likely to lead members and clients towards a debt trap (ref #3).
...
to 3-5% for traditional businesses (ref#4). Credit unions, a type of cooperative bank, had five times lower failure rate than other banks during the financial
crisis (ref #5) and more than doubled lending to small businesses between 2008 and 2016, from $30 billion to $60 billion, while lending to small businesses
...
small businesses are five times less likely to be dissatisfied with a credit union than with a big bank (ref #6). It is reported universally in the literature that the prospect of laying off or firing fellow workers is very painful. This is especially so in collectives, where the communities are tightly knit and people develop bonds of friendship with each other. Even in situations where close friendships do not develop, there usually remains mutual respect and a sense of obligation to each other—a sense of “we’re in this thin together.”.As a rule, workers prefer the continued employment of as much of the workforce as possible to the retention of high revenues (WORKER COOPERATIVES AND REVOLUTION: HISTORY AND POSSIBILITIES IN THE UNITED STATES  Chris Wright 2014 Published by BookLocker.com, Inc., Bradenton, Florida. page 18 para 2, page 29 para 2).Worker-owners take their “supervisor” much less
seriously than in conventional workplaces because his continued employment depends on their goodwill (ref #7).
...
3)Capital and the Debt Trap Capital and the Debt Trap: Learning from cooperatives in the global crisis 2011th Edition
by Claudia Sanchez Bajo (Author), Bruno Roelants  (Author) 2011, p.219<br/>
4)"How Did Bank Lending to Small Business in the United States Fare After the Financial Crisis? - The U.S. Small Business Administration – SBA.gov".
www.sba.gov. Archived from the original on 28 August 2019. Retrieved 29 November 2018<br/>
5)"A11 Report – Alberta Co-op Survival (PDF)" (PDF). Archived (PDF) from
the original on 14 July 2016. Retrieved 1 April 2017<br/>
6)"Credit Unions Twice as Trusted as Big Banks". Archived from the original on 29 November 2018. Retrieved 29 November 2018<br/>
7)^Chris Wright page 38 para 4<br/>
8)^Chris Wright page 14 para 2<br/>
9)David Morris The Mondragon System: Cooperation at work May 1992 https://www.ilsr.org/wp-content/uploads/files/images/mondragon.pdf Institute for Local
Self-Reliance page 38 para 4-5<br/>
10)^David Morris page 2 para 4<br/>
    </div>
    </p>
  ...
  <iframe style={{width:"37vw",height:"40vh",display:"inline"}} src={"https://www.youtube.com/embed/4Y7W6G6LQmM"} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  <iframe style={{marginLeft:"5vw",width:"37vw",height:"40vh",display:"inline"}} src={"https://www.youtube.com/embed/TGT2CzkUfdM"} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  <iframe style={{width:"37vw",height:"40vh",display:"inline"}} src={"https://www.youtube.com/embed/8ZoI0C1mPek"} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  <iframe style={{marginLeft:"5vw",width:"37vw",height:"40vh",display:"inline"}} src={"https://www.youtube.com/embed/5dm114sD4I8"} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  </div>
    )}
