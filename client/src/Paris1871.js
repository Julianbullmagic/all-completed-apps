...
async function getVisitorInfo(){
 ...
 console.log('countryDetails',user)
  ...
  return (
    ...
    The Paris Commune of 1871 is a very little known social revolution that is rarely discussed in the mass media despite it's great historic significance. It was the first sincerely democratic experiment in history, a genuine working class revolution (ref #1). This event
