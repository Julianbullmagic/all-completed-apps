...
coerced into paying off mortgages for several decades. The root of this problem is that our political system is not really very democratic
...
unelected and unaccountable to most of the people who work for the organization. They mostly only listen to the workers if the
government or unions force them to. This does not necessarily need to be the case. Around the world there are millions of Democratic
businesses with hundreds of millions of members. Businesses where the workers are the shareholders, can elect their own leaders and vote
on how to distribute profits. This is a very old and very reliable model of organization. There have even been some countries like
Yugoslavia, Lybia and Rojava that have attempted to make the entire private market sector of their economy organized this way.
</p>
...
off work that was necessary to participate in politics. If someone is struggling to meet their own basic needs because of poverty,
 (housing, food, medicine, social interaction etc) they cannot think about a long term plan for their own lives and they certainly
...
The choice of leaders or experts should be purely based on their skill, experience, trustworthyness, wisdom, moral integrity and
knowledge. Leader selectino should have nothing to do with how much money candidates have to spend on a political marketing campaigns
...
<p>
Only the votes of active members are counted on this website. If you have logged into the application three times or more in the last month,
you are an active user and all your votes are counted. If you log in less often than that, your votes are still recorded but not counted.
If you become an active user again, your votes that have been stored in our database will count again. If you don't log in at all for
three months, your account and votes are deleted.
</p>
<p>
...
must interact with them personally and witness
